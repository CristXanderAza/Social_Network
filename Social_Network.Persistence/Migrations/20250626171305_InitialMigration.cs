    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BattleShipGameId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ships_BattleShipGames_BattleShipGameId",
                        column: x => x.BattleShipGameId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attacks_BattleShipGames_BattleShipGameId",
                        column: x => x.BattleShipGameId,
                        principalTable: "BattleShipGames",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Attacks_Ships_ShipId",
                        column: x => x.ShipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attacks_BattleShipGameId",
                table: "Attacks",
                column: "BattleShipGameId");

            migrationBuilder.CreateIndex(
                name: "IX_Attacks_ShipId",
                table: "Attacks",
                column: "ShipId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ships_BattleShipGameId",
                table: "Ships",
                column: "BattleShipGameId");
        }
